...
mkdir -p /home/eduk8s/bin/springdir && cd bin
curl https://repo.spring.io/release/org/springframework/boot/spring-boot-cli/2.5.0/spring-boot-cli-2.5.0-bin.zip -o /home/eduk8s/bin/springdir
export PATH=/home/eduk8s/bin/springdir:$PATH
